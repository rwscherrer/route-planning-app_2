class CartedProductsController < ApplicationController
  ...
  def distance
    ...
    @carted_products.each do |carted_product|
      ...
      @carted_jobs << carted_product.in_progress
    ...
    # @element_count = @carted_jobs.length / @carted_products.count
    ...
    #     @carted_in_progress << carted_product.job.id
    #   end
    # end
    ...
    # @priority_count = @carted_jobs.length / @element_count
    # @first_priority = 1
    # @next_priority = @first_priority + 1
    ...
    # @distance_1 = Geocoder::Calculations.distance_between(@best_coord, @coord_1)
    # @distance_2 = Geocoder::Calculations.distance_between(@best_coord, @coord_2)
    # @distance_3 = Geocoder::Calculations.distance_between(@best_coord, @coord_3)
    ...
    # @progress_priority[0] << @job_1_address
    # @progress_priority[1] << @job_2_address
    # @progress_priority[2] << @job_3_address
